...
Translations: gettext domain "outlook-calendar@caio-hat" loaded from
~/.local/share/locale. See po/outlook-calendar@caio-hat.pot.
"""
...
def _fetch_ics(url, timeout=20):
    ...
    req.add_header("User-Agent", "OutlookCalendarCinnamonApplet/2.2")
